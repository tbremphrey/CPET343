...
set_global_assignment -name VHDL_FILE ../../src/add_sub_top.vhd
...
set_location_assignment PIN_AA24 -to a_num_out[0]
set_location_assignment PIN_Y23  -to a_num_out[1]
set_location_assignment PIN_Y24  -to a_num_out[2]
set_location_assignment PIN_W22  -to a_num_out[3]
set_location_assignment PIN_W24  -to a_num_out[4]
set_location_assignment PIN_V23  -to a_num_out[5]
set_location_assignment PIN_W25  -to a_num_out[6]

set_location_assignment PIN_AB23 -to b_num_out[0]
set_location_assignment PIN_AE29 -to b_num_out[1]
set_location_assignment PIN_AD29 -to b_num_out[2]
set_location_assignment PIN_AC28 -to b_num_out[3]
set_location_assignment PIN_AD30 -to b_num_out[4]
set_location_assignment PIN_AC29 -to b_num_out[5]
set_location_assignment PIN_AC30 -to b_num_out[6]
...
set_location_assignment PIN_AA15 -to add_button
set_location_assignment PIN_AA14 -to sub_button

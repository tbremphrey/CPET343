...
add wave -noupdate /add_sub_tb/uut/add_button
add wave -noupdate /add_sub_tb/uut/sub_button
add wave -noupdate /add_sub_tb/uut/a
add wave -noupdate /add_sub_tb/uut/b
add wave -noupdate -radix States /add_sub_tb/uut/a_num_out
add wave -noupdate -radix States /add_sub_tb/uut/b_num_out
add wave -noupdate -radix States /add_sub_tb/uut/result_out
add wave -noupdate /add_sub_tb/uut/add_sub_main/add_temp
add wave -noupdate /add_sub_tb/uut/add_sub_main/sub_temp

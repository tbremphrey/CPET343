...
set_location_assignment PIN_AF9  -to inputBits[0]
set_location_assignment PIN_AF10 -to inputBits[1]
set_location_assignment PIN_AD11 -to inputBits[2]
set_location_assignment PIN_AD12 -to inputBits[3]
set_location_assignment PIN_AE11 -to inputBits[4]
set_location_assignment PIN_AC9  -to inputBits[5]
set_location_assignment PIN_AD10 -to inputBits[6]
set_location_assignment PIN_AE12 -to inputBits[7]

set_location_assignment PIN_AE26 -to onesSSD[0]
set_location_assignment PIN_AE27 -to onesSSD[1]
set_location_assignment PIN_AE28 -to onesSSD[2]
set_location_assignment PIN_AG27 -to onesSSD[3]
set_location_assignment PIN_AF28 -to onesSSD[4]
set_location_assignment PIN_AG28 -to onesSSD[5]
set_location_assignment PIN_AH28 -to onesSSD[6]

set_location_assignment PIN_AJ29 -to tensSSD[0]
set_location_assignment PIN_AH29 -to tensSSD[1]
set_location_assignment PIN_AH30 -to tensSSD[2]
set_location_assignment PIN_AG30 -to tensSSD[3]
set_location_assignment PIN_AF29 -to tensSSD[4]
set_location_assignment PIN_AF30 -to tensSSD[5]
set_location_assignment PIN_AD27 -to tensSSD[6]

set_location_assignment PIN_AB23 -to hundredsSSD[0]
set_location_assignment PIN_AE29 -to hundredsSSD[1]
set_location_assignment PIN_AD29 -to hundredsSSD[2]
set_location_assignment PIN_AC28 -to hundredsSSD[3]
set_location_assignment PIN_AD30 -to hundredsSSD[4]
set_location_assignment PIN_AC29 -to hundredsSSD[5]
set_location_assignment PIN_AC30 -to hundredsSSD[6]
